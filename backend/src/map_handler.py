...
def fetch_route_from_api(start_lat, start_lng, end_lat, end_lng):
...
def get_evacuate_map(start_lat, start_lng, end_lat, end_lng):
    ...
    return {
        'route_map': fetch_route_from_api(start_lat, start_lng, end_lat, end_lng),
